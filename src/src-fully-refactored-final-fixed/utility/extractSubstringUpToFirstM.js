 ...
 * @param {number} startIndex - The index at which to start extracting the 19-character substring.
 ...
 */
function extractSubstringUpToFirstM(inputString, startIndex) {
  // Extract a substring of length 19 starting from startIndex
  const substring = inputString.slice(startIndex, startIndex + 19);

  // Use findFirstCodePointInRange to find the index of a specific pattern in the substring
...
module.exports = extractSubstringUpToFirstM;