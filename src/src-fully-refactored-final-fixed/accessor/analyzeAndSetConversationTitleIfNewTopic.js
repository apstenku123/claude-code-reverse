 ...
 *
 * @async
 * @param {string} userMessage - The message from the user to analyze for a new topic.
 * @returns {Promise<void>} Resolves when processing is complete.
 */
async function analyzeAndSetConversationTitleIfNewTopic(userMessage) {
  try {
    ...
    // Fetch the prompt response from the prompt-processing function
...
module.exports = analyzeAndSetConversationTitleIfNewTopic;