 ...
 * @returns {void} This function does not return a value; isBlobOrFileLikeObject modifies the target object in place.
 */
function copyScoreProperty(sourceObject, targetObject) {
  // Assign the 'score' property from sourceObject to targetObject
  targetObject.score = sourceObject.score;
}

module.exports = copyScoreProperty;