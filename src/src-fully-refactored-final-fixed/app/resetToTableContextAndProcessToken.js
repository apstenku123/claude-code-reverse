 ...
 * sets the insertion mode to 'IN_COLUMN_GROUP_MODE', and processes the provided token.
 *
 * @param {Object} parserContext - The parser context object containing the open elements stack and processing methods.
 * @param {Object} token - The token to be processed after resetting the context.
 * @returns {void}
 */
function resetToTableContextAndProcessToken(parserContext, token) {
...
module.exports = resetToTableContextAndProcessToken;