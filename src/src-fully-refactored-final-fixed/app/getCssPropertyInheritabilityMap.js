/**
 * Returns a mapping of CSS property names to a boolean indicating whether each property is inheritable.
 *
 * This function provides a lookup object where the keys are CSS property names (in kebab-case),
 * and the values are booleans: true if the property is inheritable, false otherwise.
 *
 * @returns {Object.<string, boolean>} An object mapping CSS property names to their inheritability status.
 */
function getCssPropertyInheritabilityMap() {
  const cssPropertyInheritability = {
    "align-content": false,
    "align-items": false,
    "align-self": false,
  ...
  return cssPropertyInheritability;
}

module.exports = getCssPropertyInheritabilityMap;
