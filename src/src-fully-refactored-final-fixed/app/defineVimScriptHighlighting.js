...
function defineVimScriptHighlighting(highlightHelpers) {
  return {
    ...
    contains: [
      ...
      // Double-quoted string (supports escaped quotes and newlines)
      {
        className: "string",
        begin: /"(\\"|\n\\|[^"\n])*"/
      },
      // Comment mode using helper
      highlightHelpers.COMMENT('"', "$"),
      // Variable: matches [bwtglsav]:<identifier>
      {
        className: "variable",
        begin: /[bwtglsav]:[\w\d_]*/
      },
...
module.exports = defineVimScriptHighlighting;