...
const TransformedText = require('./renderInkText'); // renderInkText: The component that applies the transform
const renderSecondaryText = require('./renderSecondaryText'); // renderSecondaryText: Function to render secondary text
