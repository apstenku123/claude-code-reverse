 ...
 *
 * @param {Object} sourceObservable - An object that implements a getValue method.
 * @returns {any | undefined} The value associated with Ef1, or undefined if not present.
 */
function getEf1ValueFromObservable(sourceObservable) {
  // Attempt to retrieve the value for the Ef1 key from the observable
  // If not found, return undefined
  return sourceObservable.getValue(Ef1) || undefined;
}

module.exports = getEf1ValueFromObservable;