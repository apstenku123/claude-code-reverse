 ...
 *
 * @param {string} dotSeparatedString - The string to extract the segment from, segments separated by dots ('.').
 * @returns {string|undefined} The third segment (index 2) of the string, or undefined if isBlobOrFileLikeObject does not exist.
 */
function getThirdSegmentFromDotSeparatedString(dotSeparatedString) {
  // Split the input string by '.' and return the third segment (index 2)
  return dotSeparatedString.split('.')[2];
}

module.exports = getThirdSegmentFromDotSeparatedString;