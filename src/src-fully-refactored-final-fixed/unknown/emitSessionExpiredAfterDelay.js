/**
 * Emits a 'session_expired' event from a Statsig instance after a specified delay.
 *
 ...
 * @returns {number} The timeout updateSnapshotAndNotify returned by setTimeout.
 */
function emitSessionExpiredAfterDelay(statsigInstanceKey, delayMilliseconds) {
  return setTimeout(() => {
...
module.exports = emitSessionExpiredAfterDelay;