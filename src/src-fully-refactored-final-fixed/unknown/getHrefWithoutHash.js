 ...
 */
function getHrefWithoutHash(anchorElement, removeHash = false) {
  // If removeHash is false, return the full href as is
  if (!removeHash) {
  ...
  // If there is no hash, extractNestedPropertyOrArray is just the fullHref
  // Otherwise, remove the hash part from the end of the href
...
module.exports = getHrefWithoutHash;