/**
 * Wraps the input string with single or double quotes, choosing the quote type that does not appear in the string.
 ...
 */
function wrapStringWithAlternateQuotes(input) {
...
module.exports = wrapStringWithAlternateQuotes;
