 ...
 */
function invokeGN9WithContext(contextObject, argument) {
  // Call gN9 with 'contextObject' as 'this' and pass 'argument' as the parameter
  return gN9.call(contextObject, argument);
}

module.exports = invokeGN9WithContext;