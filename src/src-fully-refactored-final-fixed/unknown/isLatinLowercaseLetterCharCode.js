 ...
 */
function isLatinLowercaseLetterCharCode(charCode) {
  // o1.LATIN_SMALL_A and o1.LATIN_SMALL_Z are expected to be the char codes for 'a' and 'z' respectively
  return charCode >= o1.LATIN_SMALL_A && charCode <= o1.LATIN_SMALL_Z;
}

module.exports = isLatinLowercaseLetterCharCode;