...
// const hasPathProperty = require('utils/type_5/hasPathProperty');
// const isNonSpecialObject = require('./aLike');
// const hasAndOrProperty = require('utils/type_4/hasAndOrProperty');
// const unwrapQueryNode = require('./UR2');
// const isArrayUtility = require('utils/type/isArrayUtility');
// const isValidPattern = require('./YE');
// const getInvalidKeyErrorMessage = require('data/validation_2/getInvalidKeyErrorMessage');
// const getKeyId = require('utils/array_3/joinArrayWithDotIfArray');
// const createPatternSearcher = require('patterns/handlers/createHandlerInstance');
