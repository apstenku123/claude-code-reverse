 ...
 */
function convertStringToUpperWithTransform(inputString) {
  // Apply the external V5 transformation, then convert the result to uppercase
  return V5(inputString).toUpperCase();
}

module.exports = convertStringToUpperWithTransform;