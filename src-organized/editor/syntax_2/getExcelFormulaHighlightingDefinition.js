 ...
 *
 * @param {object} syntaxHelpers - An object containing syntax helper definitions and utilities (e.g., escape sequences, string/number modes, comment mode generator).
 * @returns {object} Syntax highlighting definition for Excel formulae.
 */
function getExcelFormulaHighlightingDefinition(syntaxHelpers) {
  return {
    name: "Excel formulae",
    aliases: ["xlsx", "xls"],
    case_insensitive: true,
    keywords: {
      // Pattern for valid Excel formula keywords (functions, etc.)
      $pattern: /[a-zA-Z][\w\.]*/,
      // List of built-in Excel functions and keywords
    ...
    contains: [
      // Excel formulae typically start with '='
      {
        begin: /^=/,
        end: /[^=]/,
        returnEnd: true,
      ...
      // Cell references like A1, B2, AA10, etc.
      {
        className: "symbol",
      ...
      // Range references like A1:B2, AA:BB, 1:10, etc.
      {
        className: "symbol",
        begin: /[a-zA]{0,2}\d*:[a-zA]{0,2}\d*/,
        relevance: 0
      },
      // Backslash escape sequences (from syntaxHelpers)
      syntaxHelpers.BACKSLASH_ESCAPE,
      // String literals (from syntaxHelpers)
      ...
      // Excel'createInteractionAccessor operateWithLeadingTrailing() comment function, e.g., operateWithLeadingTrailing("comment")
...
module.exports = getExcelFormulaHighlightingDefinition;