 ...
 */
function mapAttributesWithDropCount(sourceObject) {
  return {
    // Transform the 'attributes' property using the external IR0 function
...
module.exports = mapAttributesWithDropCount;