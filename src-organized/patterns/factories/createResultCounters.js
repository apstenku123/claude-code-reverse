 ...
 *
 * @returns {{ success: number, failure: number }} An object with counters for successes and failures, both initialized to 0.
 */
function createResultCounters() {
...
module.exports = createResultCounters;