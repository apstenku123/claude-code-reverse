 ...
 * @returns {object} Highlight.js language definition for Scilab.
 */
function scilabHighlightConfigFactory(hljs) {
  ...
  return {
    ...
    keywords: {
      ...
      literal: "%f %F %processRuleBeginHandlers %BugReportForm %getEndIndexOfInteractionEntry %eps %inf %nan %e %i %z %createInteractionAccessor",
    ...
    contains: [
      ...
      // Variable or property access with dot or quote
      {
      ...
      hljs.COMMENT("//", "$")
    ].concat(numberAndStringModes) // Add number and string modes at the end
  };
}

module.exports = scilabHighlightConfigFactory;
