/**
 * Checks if the substring starting at the specified index in the input string matches the keyword '!ENTITY'.
 *
 * @param {string} inputString - The string to search within.
 * @param {number} startIndex - The index at which to check for the '!ENTITY' keyword.
 * @returns {boolean} True if '!ENTITY' is found at the specified position, otherwise false.
 */
function isEntityKeywordAtPosition(inputString, startIndex) {
  // Check if the substring at the given position matches '!ENTITY'
  return (
...
module.exports = isEntityKeywordAtPosition;