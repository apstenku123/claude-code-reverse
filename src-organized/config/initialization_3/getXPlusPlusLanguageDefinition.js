 ...
 *
 * @param {object} hljs - The highlight.js core library object, providing language modes and utilities.
 * @returns {object} The language definition object for X++ to be used with highlight.js.
 */
function getXPlusPlusLanguageDefinition(hljs) {
  return {
    name: "X++",
    aliases: ["x++"],
    keywords: {
    ...
    contains: [
      ...
      // Class and interface definitions
      {
        ...
        contains: [
          {
            beginKeywords: "extends implements" // Support for inheritance/implementation
          },
...
module.exports = getXPlusPlusLanguageDefinition;