/**
 * Defines syntax highlighting rules for the HSP (Hot Soup Processor) language.
 *
 * @param {object} hljs - The highlight.js library instance, providing language modes and helpers.
 * @returns {object} An object describing the syntax highlighting configuration for HSP.
 */
function defineHspHighlighting(hljs) {
  return {
    name: "HSP",
    case_insensitive: true, // HSP is case-insensitive
    keywords: {
      $pattern: /[\w._]+/, // Match words, underscores, and periods
      keyword:
    ...
    contains: [
      ...
      // HSP comment lines starting with ';'
      hljs.COMMENT(";", "$", {
        relevance: 0
      }),
      ...
      // HSP label/symbol definition (e.g., *label or *@)
      {
        className: "symbol",
        begin: /^\*(\w+|@)/
      },
...
module.exports = defineHspHighlighting;