/**
 * Defines syntax highlighting rules for the XL programming language (and its alias 'tao').
 *
 * @param {object} hljs - The highlight.js library instance, used to access built-in modes and helpers.
 * @returns {object} Highlight.js language definition for XL.
 */
function defineXLHighlighting(hljs) {
  ...
  // XL number literal mode (supports base notation and exponents)
  ...
  // Function definition mode (matches 'name ... ->')
  ...
  // Return the language definition object for highlight.js
  return {
    name: "XL",
    aliases: ["tao"],
    keywords: xlKeywords,
...
module.exports = defineXLHighlighting;
